...
```
---
> Операто конкатенации можно использовать в шаблоне оператора [***`LIKE`***](https://github.com/egorbeckish/ArtificialIntelligence/tree/main/SQL+PL-pgSQL/SQL/OperatorsStructure/LIKE)
