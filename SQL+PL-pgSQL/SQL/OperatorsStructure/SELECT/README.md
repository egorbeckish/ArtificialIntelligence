...
Запрос 1. [Вывод содержимого одного столбца](https://github.com/egorbeckish/ArtificialIntelligence/tree/main/SQL+PL-pgSQL/SQL/OperatorsStructure/SELECT/sql/query1.sql)
```sql
SELECT
	employee_id
FROM
...
Запрос 2. [Вывод содержимого нескольких столбцов](https://github.com/egorbeckish/ArtificialIntelligence/tree/main/SQL+PL-pgSQL/SQL/OperatorsStructure/SELECT/sql/query2.sql)
```sql
SELECT
	employee_id,
	first_name,
...
Запрос 3. [Вывод значений всех столбцов](https://github.com/egorbeckish/ArtificialIntelligence/tree/main/SQL+PL-pgSQL/SQL/OperatorsStructure/SELECT/sql/query3.sql)
```sql
SELECT
	*
FROM
...
Запрос 4. [Вывод значений столбца job_id](https://github.com/egorbeckish/ArtificialIntelligence/tree/main/SQL+PL-pgSQL/SQL/OperatorsStructure/SELECT/sql/query4.sql)
```sql
SELECT
	job_id
FROM
...
Запрос 5. [Вывод значений столбца job_id без дублирования](https://github.com/egorbeckish/ArtificialIntelligence/tree/main/SQL+PL-pgSQL/SQL/OperatorsStructure/SELECT/sql/query5.sql)
```sql
SELECT
	DISTINCT job_id
FROM
