...
--|timestamptz                     |
--|--------------------------------|
--|1970-01-01 12:30:45.123456 +0700|
```

Запрос 3. [Пример использования функции TIMESTAMP с учетом точности](https://github.com/egorbeckish/ArtificialIntelligence/blob/main/SQL+PL-pgSQL/SQL/TypesAndFunctions/3.DateTimeType/TIME/sql/query3.sql)
```sql
SELECT
