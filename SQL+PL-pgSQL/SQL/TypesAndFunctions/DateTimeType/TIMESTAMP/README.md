...
Запрос 1. [Пример использования функции TIMESTAMP без учета точности](https://github.com/egorbeckish/ArtificialIntelligence/blob/main/SQL+PL-pgSQL/SQL/TypesAndFunctions/3.DateTimeType/TIMESTAMP/sql/query1.sql)
```sql
SELECT
...
Запрос 2. [Пример использования функции TIMESTAMP WITH TIME ZONE без учета точности](https://github.com/egorbeckish/ArtificialIntelligence/blob/main/SQL+PL-pgSQL/SQL/TypesAndFunctions/3.DateTimeType/TIMESTAMP/sql/query2.sql)
```sql
SELECT
...
Запрос 3. [Пример использования функции TIMESTAMP с учетом точности](https://github.com/egorbeckish/ArtificialIntelligence/blob/main/SQL+PL-pgSQL/SQL/TypesAndFunctions/3.DateTimeType/TIMESTAMP/sql/query3.sql)
```sql
SELECT
...
Запрос 4. [Пример использования функции TIMESTAMP WITH TIME ZONE  с учетом точности](https://github.com/egorbeckish/ArtificialIntelligence/blob/main/SQL+PL-pgSQL/SQL/TypesAndFunctions/3.DateTimeType/TIMESTAMP/sql/query4.sql)
```sql
SELECT
